    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage && i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
                        entries.push('<div class="rows name row' + i + (entry.desc ? '' : ' fn-wide') + '" id="rowheader' + i + '" offset="' + i % settings.itemsPerPage * tools.getCellSize() + '">');
                        entries.push('<span class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '">' + entry.name + '</span>');
                        entries.push('</div>');

                        if (entry.desc) {
                            entries.push('<div class="rows desc row' + i + ' " id="RowdId_' + i + '" data-id="' + entry.id + '">');
            ...
            rightPanel: function (element, leftPanel) {
                ...
                var yearArr = ['<div class="rows"/>'];
                var daysInYear = 0;

                var monthArr = ['<div class="rows"/>'];
                var daysInMonth = 0;
                ...
                switch (settings.scale) {
                    ...
                    case "hours":
                        ...
                        for (var i = 0; i < range.length; i++) {
                            ...
                            if (rfy !== year) {
                                yearArr.push(
                                    ('<div class="rows header year" style="width: '
                            ...
                            if (rm !== month) {
                                monthArr.push(
                                    ('<div class="rows header month" style="width: '
                            ...
                            if (rgetDay !== getDay) {
                                ...
                                dayArr.push('<div class="rows date ' + day_class2 + '" '
                                        + ' style="width: ' + tools.getCellSize() * hoursInDay + 'px;"> '
                                        + ' <div class="fn-label">' + day.getDate() + '</div></div>');
                                dowArr.push('<div class="rows day ' + day_class2 + '" '
                                        + ' style="width: ' + tools.getCellSize() * hoursInDay + 'px;"> '
                            ...
                            horArr.push('<div class="rows day '
                                    + day_class
                                    + '" id="dh-'
                                    + rday.getTime()
                       ...
                       yearArr.push(
                        ...
                        dayArr.push('<div class="rows date ' + day_class + '" '
                                + ' style="width: ' + tools.getCellSize() * hoursInDay + 'px;"> '
                                + ' <div class="fn-label">' + day.getDate() + '</div></div>');

                        dowArr.push('<div class="rows day ' + day_class + '" '
                                + ' style="width: ' + tools.getCellSize() * hoursInDay + 'px;"> '
                        ...
                        dataPanel.append($('<div class="rows"/>').html(dayArr.join("")));
                        dataPanel.append($('<div class="rows"/>').html(dowArr.join("")));
                        dataPanel.append($('<div class="rows"/>').html(horArr.join("")));
                    ...
                    case "weeks":
                        ...
                        yearArr = ['<div class="rows"/>'];
                        monthArr = ['<div class="rows"/>'];
                        var year = range[0].getFullYear();
                        var month = range[0].getMonth();
                        var day = range[0];
                        ...
                        for (var i = 0; i < range.length; i++) {
                            ...
                            // Fill weeks
                            dayArr.push('<div class="rows day wd" '
                    ...
                    case 'months':
                        ...
                        for (var i = 0; i < range.length; i++) {
                            ...
                            daysInYear++;
                            monthArr.push('<div class="rows day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.genRepDate() + '">' + (1 + rday.getMonth()) + '</div>');
                        }
        ...
        var tools = {
            ...
            getCellSize: function () {
                if (!tools._getCellSize) {
                    $("body").append(
                        $('<div style="display: none; position: absolute;" class="fn-gantt" id="measureCellWidth"><div class="rows"></div></div>')
                    );
                    tools._getCellSize = $("#measureCellWidth .rows").height();
            ...
            getProgressBarMargin: function () {
                if (!tools._getProgressBarMargin) {
                    $("body").append(
                        $('<div style="display: none; position: absolute;" id="measureBarWidth" ><div class="fn-gantt"><div class="rightPanel"><div class="dataPanel"><div class="rows day"><div class="bar" /></div></div></div></div></div>')
                    );
