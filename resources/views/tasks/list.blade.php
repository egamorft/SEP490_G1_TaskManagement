                ...
                <div class="todo-title-wrapper">
                    <div class="todo-title-area">
                        ...
                        <div class="title-wrapper">
                            ...
                            <span class="todo-title">Hire 5 new Fresher or Experienced, frontend and backend developers
                            </span>
                        </div>
                    </div>
                    <div class="todo-item-action">
                ...
                <div class="todo-title-wrapper">
                    <div class="todo-title-area">
                        ...
                        <div class="title-wrapper">
                            ...
                            <span class="todo-title">Submit quotation for Abid's ecommerce website and admin project
                            </span>
                        </div>
                    </div>
                    <div class="todo-item-action">
                ...
                <div class="todo-title-wrapper">
                    <div class="todo-title-area">
                        ...
                        <div class="title-wrapper">
                            ...
                            <span class="todo-title">Plan new dashboard design with design team for Google app store.
                            </span>
                        </div>
                    </div>
                    <div class="todo-item-action">
                ...
                <div class="todo-title-wrapper">
                    <div class="todo-title-area">
                        ...
                        <div class="title-wrapper">
                            ...
                            <span class="todo-title">Test functionality of apps developed by dev team for enhancements.
                            </span>
                        </div>
                    </div>
                    <div class="todo-item-action">
