                ...
                <li class="todo-item">
                    <div class="todo-title-wrapper">
                        ...
                        <div class="todo-item-action">
                            ...
                            <div class="avatar">
                                <img src="{{ asset('images/portrait/small/avatar-s-4.jpg') }}" alt="user-avatar"
                                    height="32" width="32" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="todo-title-wrapper">
                        <div class="todo-title-area">
                            ...
                            <div class="title-wrapper">
                                ...
                                <span class="todo-title">Hire 5 new Fresher or Experienced, frontend and backend
                                    developers </span>
                            </div>
                        </div>
                        <div class="todo-item-action">
                            ...
                            <div class="avatar">
                                <img src="{{ asset('images/portrait/small/avatar-s-5.jpg') }}" alt="user-avatar"
                                    height="32" width="32" />
                            </div>
                        </div>
                    </div>
                ...
                <li class="todo-item completed">
                    <div class="todo-title-wrapper">
                        ...
                        <div class="todo-item-action">
                            ...
                            <div class="avatar">
                                <img src="{{ asset('images/portrait/small/avatar-s-8.jpg') }}" alt="user-avatar"
                                    height="32" width="32" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="todo-title-wrapper">
                        <div class="todo-title-area">
                            ...
                            <div class="title-wrapper">
                                ...
                                <span class="todo-title">Submit quotation for Abid's ecommerce website and admin
                                    project </span>
                            </div>
                        </div>
                        <div class="todo-item-action">
                            ...
                            <div class="avatar">
                                <img src="{{ asset('images/portrait/small/avatar-s-11.jpg') }}" alt="user-avatar"
                                    height="32" width="32" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="todo-title-wrapper">
                        <div class="todo-title-area">
                            ...
                            <div class="title-wrapper">
                                ...
                                <span class="todo-title">List out all the SEO resources and send it to new SEO team.
                                </span>
                            </div>
                        </div>
                        <div class="todo-item-action">
                ...
                <li class="todo-item">
                    <div class="todo-title-wrapper">
                        ...
                        <div class="todo-item-action">
                            ...
                            <small class="text-nowrap text-muted me-1">Aug 28</small>
                            <div class="avatar">
                                <img src="{{ asset('images/portrait/small/avatar-s-7.jpg') }}" alt="user-avatar"
                                    height="32" width="32" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="todo-title-wrapper">
                        <div class="todo-title-area">
                            ...
                            <div class="title-wrapper">
                                ...
                                <span class="todo-title">Plan new dashboard design with design team for Google app
                                    store. </span>
                            </div>
                        </div>
                        <div class="todo-item-action">
                    ...
                    <div class="todo-title-wrapper">
                        <div class="todo-title-area">
                            ...
                            <div class="title-wrapper">
                                ...
                                <span class="todo-title">Conduct a mini awareness meeting regarding health care.
                                </span>
                            </div>
                        </div>
                        <div class="todo-item-action">
                            ...
                            <div class="avatar">
                                <img src="{{ asset('images/portrait/small/avatar-s-17.jpg') }}" alt="user-avatar"
                                    height="32" width="32" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="todo-title-wrapper">
                        <div class="todo-title-area">
                            ...
                            <div class="title-wrapper">
                                ...
                                <span class="todo-title">Test functionality of apps developed by dev team for
                                    enhancements. </span>
                            </div>
                        </div>
                        <div class="todo-item-action">
                    ...
                    <div class="todo-title-wrapper">
                        <div class="todo-title-area">
                            ...
                            <div class="title-wrapper">
                                ...
                                <span class="todo-title">Answer the support tickets and close completed tickets.
                                </span>
                            </div>
                        </div>
                        <div class="todo-item-action">
                ...
                <li class="todo-item">
                    <div class="todo-title-wrapper">
                        ...
                        <div class="todo-item-action">
                            ...
                            <div class="avatar">
                                <img src="{{ asset('images/portrait/small/avatar-s-2.jpg') }}" alt="user-avatar"
                                    height="32" width="32" />
                            </div>
                        </div>
                    </div>
