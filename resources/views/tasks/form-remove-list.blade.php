{{-- <div class="modal modal-slide-in sidebar-todo-modal fade" id="remove-task-list-modal">
			...
			<form id="form-modal-task-list" class="todo-modal needs-validation" action="{{ route('create.task.list', ["slug" => $project->slug]) }}" method="POST">
				...
				<div class="modal-body flex-grow-1 pb-sm-0 pb-3">
					<div class="action-tags">
						<div class="mb-1">
							<label for="listTitleAdd" class="form-label">Confirm to remove Task List</label>
