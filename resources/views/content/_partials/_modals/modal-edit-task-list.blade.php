<!-- Edit User Modal -->
<div class="modal fade" id="editTaskList{{ $task->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <form id="addTaskListForm" class="row gy-1 pt-75"
                    action="{{ route('edit.task.list', ['slug' => $project->slug, 'list_id' => $task->id]) }}" method="POST">
                    @csrf
