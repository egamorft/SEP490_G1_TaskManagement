            ...
            <form action="" method="GET" class="formUploadComment">
                <div class="comment-item-wrapper">
                    <img class="comment-item-image"
                        ...
                        alt="IMG" />
                    <input type="text" id="comment-input" name="commentInput" class="form-control"
                        placeholder="Write your comment here" value="" data-msg="Please enter your comment" />
                </div>
                ...
                <div class="comment-item-wrapper">
                    ...
                    <div class="comment-item-info">
                        ...
                        <input type="text" id="comment-input" name="commentInput" class="form-control"
                            placeholder="Write your comment here" value="Test thử xem input được chưa"
