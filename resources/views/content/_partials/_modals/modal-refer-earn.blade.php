                ...
                <div class="px-sm-5 mx-50">
                    ...
                    <form id="modalInviteForm" class="row g-1"
                        ...
                        <div class="col-lg-10">
                            ...
                            <input {{ $checkLimitation >= 6 ? 'disabled' : '' }} type="text" id="modalInviteEmail"
                                class="form-control" name="modalInviteEmail"
                                placeholder="{{ $checkLimitation >= 6 ? 'Your team have reached limitation of invitation' : 'Enter your teammate email' }}"
                        ...
                        <div class="col-lg-2 d-flex align-items-end">
                            ...
                            <button {{ $checkLimitation >= 6 ? 'disabled' : '' }} type="submit" id="submitBtnInvite"
                                class="btn btn-primary w-100">{{ $checkLimitation >= 6 ? 'Limited' : 'Send' }}</button>
                        </div>
                    </form>
