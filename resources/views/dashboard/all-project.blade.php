            ...
            <tr class="odd" id="row{{ $project->id }}">
                ...
                <td>
                    <div class="d-flex justify-content-left align-items-center">
                        <div class="more-info">
                            ...
                            <small class="text-truncate" style="max-width: 300px; display: block;">{{ $project->description ? $project->description : 'No Description'}}</small>
                        </div>
                    </div>
                </td>
                <td>
                ...
                <td>
					<div class="avatar float-start bg-white rounded">
                        <a href="{{ route('view.project.member', ['slug' => $project->slug, 'user_id' => $manager->id]) }}" class="avatar float-start bg-white rounded me-1">
				...
				<td>
					<div class="avatar float-start bg-white rounded">
                        <a href="{{ $supervisor ? route('view.project.member', ['slug' => $project->slug, 'user_id' => $supervisor->id]) : '#' }}" class="avatar float-start bg-white rounded me-1">
