                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><a
                                                                        ...
                                                                        style="outline:none" tabindex="-1"><img
                                                                            ...
                                                                            width="147" alt="Company Logo"
                                                                            title="Company Logo"></a></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img class="big"
                                                                        ...
                                                                        width="680" alt="Top round corners"
                                                                        title="Top round corners"></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                            ...
                                                            <td class="pad">
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img
                                                                        ...
                                                                        width="374" alt="Resetting Password"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:14px;">Access below
                                                            ...
                                                            <td class="pad">
                                                                <div class="alignment" align="center">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.example.com" style="height:44px;width:160px;v-text-anchor:middle;" arcsize="10%" strokeweight="0.75pt" strokecolor="#101" fillcolor="#101"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a
                                                                        href="{{ route('reset.password', ['token' => $token]) }}"
                                                                        target="_blank"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img class="big"
                                                                        ...
                                                                        style="display: block; height: auto; border: 0; width: 680px; max-width: 100%;"
                                                                        width="680" alt="Bottom round corners"
                                                                        title="Bottom round corners"></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
