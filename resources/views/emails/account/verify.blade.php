                                                    ...
                                                    <table class="image_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><a href="{{ route('dashboard') }}"
                                                                        target="_blank" style="outline:none"
                                                                        tabindex="-1"><img
                                                                            src="https://ucarecdn.com/27309e4e-1cf5-47f2-8231-f1d14f1d2153/"
                                                                            style="display: block; height: auto; border: 0; width: 180px; max-width: 100%;"
                                                                            width="180" alt="I'm an image"
                                                                            title="I'm an image"></a></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img class="big"
                                                                        src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/1361/Img4_2x.jpg"
                                                    ...
                                                    <table class="button_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:62px;width:164px;v-text-anchor:middle;" arcsize="97%" stroke="false" fillcolor="#1aa19c"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px"><![endif]--><a
                                                                        href="{{ route('verify.account') }}" target="_blank"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><a href="{{ route('dashboard') }}"
                                                                        ...
                                                                        tabindex="-1"><img
                                                                            ...
                                                                            width="128" alt="Alternate text"
                                                                            title="Alternate text"></a></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table class="divider_block block-3" width="100%"
