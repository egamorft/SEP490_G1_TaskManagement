                            ...
                            @if (isset($menu->navheader))
                                ...
                                @else
                                    @if (isset($menu->navitems))
                                        <li
                                            class="nav-item {{ $menu->class }}" id="{{ $menu->id }}">
                                            <span class="my-project-items menu-title text-truncate">
                                                {{ $menu->html }}
                                            </span>
                                        </li>
                                    @else
                                        ...
                                        <li
                                            ...
                                            <a href="{{ isset($menu->url) ? url($menu->url) : 'javascript:void(0)' }}"
                                                class="d-flex align-items-center"
                                                target="{{ isset($menu->newTab) ? '_blank' : '_self' }}">
                                                <i data-feather="{{ isset($menu->icon) ? $menu->icon : '' }}"></i>
                                                <span
                                                    class="menu-title text-truncate">{{ __(isset($menu->name) ? $menu->name : '') }}</span>
                                                @if (isset($menu->badge))
                                                    <?php $badgeClasses = 'badge rounded-pill badge-light-primary ms-auto me-1'; ?>
                                                    <span
                                                        class="{{ isset($menu->badgeClass) ? $menu->badgeClass : $badgeClasses }}">{{ $menu->badge }}</span>
