                    ...
                    <div class="mb-2 kanban-detail-progress">
                        <div class="mb-1 flex-box">
                            ...
                            <div class="kanban-detail-date">
                                ...
                                <div class="flex-box">
                                    <input class="form-check-input checkbox-finish-task" type="checkbox" value=""
                                        id="flexCheckChecked">
                        ...
                        <div class="mb-1">
                            <div class="description-header flex-box">
                                ...
                                <div class="description-side">
                                    <button class="btn btn-secondary description-button-edit custom-button">Chỉnh
                                        sửa</button>
                                </div>
                            </div>
