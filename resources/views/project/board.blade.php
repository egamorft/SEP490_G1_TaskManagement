...
@section('content')
    ...
    @php
        $logo = Str::substr($project->name, 0, 1) . '.png';
    @endphp
    <div class="content-header row mb-0">
        <h1 class="content-header-left col-md-9 col-12 mb-0">
            <img class="rounded me-1" src="{{ Auth::user() ? asset('images/avatars/' . $logo) : '' }}" alt="avatar"
                height="36" width="36">
            <span class="menu-title text-truncate">{{ $project->name }}</span>
        </h1>
